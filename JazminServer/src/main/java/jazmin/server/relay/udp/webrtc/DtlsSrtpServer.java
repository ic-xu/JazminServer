...
public class DtlsSrtpServer extends DefaultTlsServer {
	...
	private static final String[] CERT_RESOURCES = new String[] { "cert/x509-server.pem","cert/x509-ca.pem"};//, "x509-ca.pem"
	private static final String KEY_RESOURCE = "cert/x509-server-key.pem";
